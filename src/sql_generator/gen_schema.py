...
SCHEMA = {
    ...
    'imdb-full' : {
        'join_tables':['title',  'aka_title',  'cast_info',  'complete_cast',  'movie_companies',  'movie_info',  'movie_info_idx',  'movie_keyword',  'movie_link',  'kind_type',  'char_name',  'role_type', 'name',  'aka_name',  'person_info',  'comp_cast_type',  'company_name',  'company_type',  'info_type',  'keyword',  'link_type', ],
    ...
    'syn-multi' : {
        ...
        'join_how': 'outer',
        'dataset': 'synthetic',
        'data_dir': 'datasets/table10_dom10_skew1.0_seed0/',
...
"""
    ...
    'imdb-full' :{
        'join_tables':['title', 'aka_title', 'cast_info', 'complete_cast', 'movie_companies', 'movie_info', 'movie_info_idx', 'movie_keyword', 'movie_link', 'kind_type', 'char_name', 'role_type', 'aka_name', 'name', 
                'comp_cast_type', 'company_name', 'company_type', 'info_type', 'keyword', 'link_type', 'person_info'],
        'join_keys': {'title': ['kind_id', 'id'],  'aka_title': ['movie_id'],  'cast_info': ['person_role_id', 'movie_id', 'person_id', 'role_id'],  'complete_cast': ['subject_id', 'movie_id'],  'movie_companies': ['movie_id', 'company_id', 'company_type_id'],  'movie_info': ['movie_id'],  'movie_info_idx': ['movie_id', 'info_type_id'],  'movie_keyword': ['keyword_id', 'movie_id'],  'movie_link': ['movie_id', 'link_type_id'],  'kind_type': ['id'],  'comp_cast_type': ['id'],  'company_name': ['id'],  'company_type': ['id'],  'info_type': ['id'],  'keyword': ['id'],  'link_type': ['id'],  'char_name': ['id'],  'role_type': ['id'],  'aka_name': ['id'],  'person_info': ['info_type_id'],  'name': ['id']},
        'join_root': 'title',
        'join_clauses': ['title.id=aka_title.movie_id',
                         'title.id=cast_info.movie_id',
                         'title.id=complete_cast.movie_id',
                         'title.id=movie_companies.movie_id',
                         'title.id=movie_info.movie_id',
    ...
    'imdb-full-rm-pi' :{
        'join_tables':['title', 'aka_title', 'cast_info', 'complete_cast', 'movie_companies', 'movie_info', 'movie_info_idx', 'movie_keyword', 'movie_link', 'kind_type', 'char_name', 'role_type', 'aka_name', 'name',
                'comp_cast_type', 'company_name', 'company_type', 'info_type', 'keyword', 'link_type'],
        'join_keys': {'title': ['kind_id', 'id'],  'aka_title': ['movie_id'],  'cast_info': ['person_role_id', 'movie_id', 'person_id', 'role_id'],  'complete_cast': ['subject_id', 'movie_id'],  'movie_companies': ['movie_id', 'company_id', 'company_type_id'],  'movie_info': ['movie_id'],  'movie_info_idx': ['movie_id', 'info_type_id'],  'movie_keyword': ['keyword_id', 'movie_id'],  'movie_link': ['movie_id', 'link_type_id'],  'kind_type': ['id'],  'comp_cast_type': ['id'],  'company_name': ['id'],  'company_type': ['id'],  'info_type': ['id'],  'keyword': ['id'],  'link_type': ['id'],  'char_name': ['id'],  'role_type': ['id'],  'aka_name': ['id'],'name': ['id']},
        'join_root': 'title',
        'join_clauses': ['title.id=aka_title.movie_id',
                         'title.id=cast_info.movie_id',
                         'title.id=complete_cast.movie_id',
     ...
     'imdb-full-r-pi-it' :{
        'join_tables':['title', 'aka_title', 'cast_info', 'complete_cast', 'movie_companies', 'movie_info', 'movie_info_idx', 'movie_keyword', 'movie_link', 'kind_type', 'char_name', 'role_type', 'aka_name', 'name', 'comp_cast_type', 'company_name', 'company_type', 'keyword', 'link_type'],
        'join_keys': {'title': ['kind_id', 'id'],  'aka_title': ['movie_id'],  'cast_info': ['person_role_id', 'movie_id', 'person_id', 'role_id'],  'complete_cast': ['subject_id', 'movie_id'],  'movie_companies': ['movie_id', 'company_id', 'company_type_id'],  'movie_info': ['movie_id'],  'movie_info_idx': ['movie_id'],  'movie_keyword': ['keyword_id', 'movie_id'],  'movie_link': ['movie_id', 'link_type_id'],  'kind_type': ['id'],  'comp_cast_type': ['id'],  'company_name': ['id'],  'company_type': ['id'],  'keyword': ['id'],  'link_type': ['id'],  'char_name': ['id'],  'role_type': ['id'],  'aka_name': ['id'], 'name': ['id']},
        'join_root': 'title',
        'join_clauses': ['title.id=aka_title.movie_id',
                         'title.id=cast_info.movie_id',
                         'title.id=complete_cast.movie_id',
