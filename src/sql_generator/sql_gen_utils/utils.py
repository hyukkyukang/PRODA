...
def JobToQuery(csv_file, use_alias_keys=True):
    ...
    with open(csv_file) as f:
        ...
        for row in data_raw:
            ...
            queries.append((list(table_dict.values()), join_dict, predicate_dict, true_cardinality))
            ...
            for cand_s, cand_t in schema_equi_joins[s_i]:
                ...
                if cand_s_i != cand_t_i:
                    if cand is None:
                        ...
                        assert False
                    query_equi_groups, query_equi_joins = merge_groups(
                        query_equi_groups, query_equi_joins, cand_s_i, cand_t_i, cand_s, cand_t
                    )
