...
BEGIN;
\copy "town" FROM '/docker-entrypoint-initdb.d/csv_data/french_employmnet_salaries_population_per_town/base.csv' CSV HEADER;
\copy "population" FROM '/docker-entrypoint-initdb.d/csv_data/french_employmnet_salaries_population_per_town/population.csv' CSV HEADER;
\copy "net_salary_per_town" FROM '/docker-entrypoint-initdb.d/csv_data/french_employmnet_salaries_population_per_town/net_salary_per_town.csv' CSV HEADER;
\copy "ori_name_geographic_information" FROM '/docker-entrypoint-initdb.d/csv_data/french_employmnet_salaries_population_per_town/name_geographic_information.csv' CSV HEADER;
END;
