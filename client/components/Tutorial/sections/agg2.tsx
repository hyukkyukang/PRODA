...
export const Agg2Section: ITutorialSection = {
    "title": "Count, Avg, Sum",
    "description": "The 'Count', 'Avg', and 'Sum' functions return the number of rows, the average of the selected column, and the sum of the selected column, respectively.",
